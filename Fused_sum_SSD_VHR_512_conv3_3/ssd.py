        ...
        if in_channels != 'S':
            if v == 'S':
                layers += [nn.Conv2d(in_channels, cfg[k + 1],
                                     kernel_size=(1, 5)[flag], stride=2, padding=(1, 0)[flag])]
            else:
...
extras = {'512': [256, 512, 128, 256, 128, 256, 128,'S',256]}
mbox = {'512': [4, 6, 6, 6, 4, 4, 4]}  # number of boxes per feature map location
