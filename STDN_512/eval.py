...
from data import VHRroot
from data import VHR_CLASSES as labelmap
from data import AnnotationTransform_VHR, VHRDetection, BaseTransform, VHR_CLASSES
from stdn import build_stdn
...
parser.add_argument('--trained_model',
                    default='/media/sunwl/Datum/Projects/GraduationProject/SSD_VHR_300/weights/ssd300_vhr_resume_40000.pth',
                    type=str, help='Trained state_dict file path to open')
parser.add_argument('--save_folder', default='/media/sunwl/Datum/Projects/GraduationProject/SSD_VHR_300/eval/',
...
parser.add_argument('--vhr_root', default=VHRroot, help='Location of VHR root directory')
...
annopath = os.path.join(args.vhr_root, "ground truth", '%s.txt')
imgpath = os.path.join(args.vhr_root, "positive image set", '%s.jpg')
imgsetpath = os.path.join(args.vhr_root, "ground truth", '{:s}.txt')
dataset_mean = (104, 117, 123)
set_type = 'test'
root_path = '/media/sunwl/Datum/Projects/GraduationProject/SSD_VHR_300'
...
def parse_rec(filename):
    ...
    for pt in target[:-1]:
        ...
        # print(cur_pt)
        obj_struct['name'] = VHR_CLASSES[cur_pt[-1] - 1]
...
if __name__ == '__main__':
    ...
    print(net)
    # load data
    dataset = VHRDetection(args.vhr_root, ['test2'], BaseTransform(512, dataset_mean),
