...
def demo_plt(img_id=0):
    ...
    print(net)
    net.load_weights('/media/sunwl/Datum/Projects/GraduationProject/Fused_concat_SSD_VHR_512/weights/v2_rosd.pth')
    ...
    for i in range(detections.size(1)):
        ...
        while detections[0, i, j, 0] >= 0.6:
            ...
            j += 1
    plt.savefig('/media/sunwl/Datum/Projects/GraduationProject/Fused_concat_SSD_VHR_512/outputs/rosd_{:03}.png'.format(img_id))
    plt.xticks([])
    plt.yticks([])
    plt.show()
