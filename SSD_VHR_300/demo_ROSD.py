...
def demo_plt(img_id=0):
    ...
    print(net)
    net.load_weights_for_rosd('/media/sunwl/Datum/Projects/GraduationProject/SSD_VHR_300/weights/v2_vhr.pth')
    ...
    for i in range(detections.size(1)):
        ...
        while detections[0, i, j, 0] >= 0.6:
            ...
            j += 1
    plt.savefig(
        '/media/sunwl/Datum/Projects/GraduationProject/SSD_VHR_300/outputs/rosd_{:03}.png'.format(img_id))
    plt.xticks([])
    plt.yticks([])
    plt.show()
