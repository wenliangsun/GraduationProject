...
ROSD_CLASSES = ('aircraft', 'oiltank', 'overpass', 'playground')

# for making bounding boxes pretty
COLORS = ((255, 0, 0, 128), (0, 255, 0, 128), (0, 0, 255, 128),
          (0, 255, 255, 128), (255, 0, 255, 128), (255, 255, 0, 128))

root_path = "/media/sunwl/Datum/Datasets/ROSD_dataset/ROSD/JPEGImages"
...
class AnnotationTransform_ROSD(object):
    ...
    def __init__(self, class_to_ind=None, keep_difficult=False):
        self.class_to_ind = class_to_ind or dict(
            zip(ROSD_CLASSES, range(len(ROSD_CLASSES))))
...
class ROSDDetection(data.Dataset):
...
def detection_collate_ROSD(batch):
