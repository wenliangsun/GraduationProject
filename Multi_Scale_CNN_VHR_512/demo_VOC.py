...
def demo_plt(img_id=0):
    net = build_msc('test', 21)
    print(net)
    net.load_weights('/media/sunwl/Datum/Projects/GraduationProject/Multi_Scale_CNN_512/weights/v2_voc.pth')
    testset = VOCDetection(VOCroot, [('2012', 'val')], None, AnnotationTransform)
    # image = testset.pull_image(img_id)
    image = cv2.imread('demos/01.png')
