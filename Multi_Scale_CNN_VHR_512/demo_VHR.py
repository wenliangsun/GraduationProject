...
def demo_plt(img_id=0):
    ...
    for i in range(detections.size(1)):
        ...
        while detections[0, i, j, 0] >= 0.5:
            ...
            j += 1
    plt.savefig('/media/sunwl/Datum/Projects/GraduationProject/Multi_Scale_CNN_512/outputs/{:03}.png'.format(img_id))
    plt.show()
...
def demo_cv2(img_id=0):
    ...
    print(net)
    # net.load_weights('/media/sunwl/Datum/Projects/GraduationProject/Multi_Scale_CNN_512/weights/v2_vhr.pth')
    net.load_weights('/media/sunwl/Datum/Projects/GraduationProject/Multi_Scale_CNN_512/weights/msc512_vhr_80000.pth')
    testset = VHRDetection(VHRroot, ['test2'], None, AnnotationTransform_VHR)
    image = testset.pull_image(img_id)
