...
parser.add_argument('--trained_model',
                    default='weights/v2_vhr.pth',
                    type=str, help='Trained state_dict file path to open')
parser.add_argument('--save_folder', default='vhr_eval/',
...
def test_net(save_folder, net, cuda, dataset, transform, top_k,
    ...
    output_dir = get_output_dir(os.path.join(root_path, 'msc512_v2_vhr'), set_type)
