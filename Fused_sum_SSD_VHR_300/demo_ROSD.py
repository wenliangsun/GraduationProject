...
def demo_plt(img_id=0):
    ...
    print(net)
    net.load_weights_for_rosd('/media/sunwl/Datum/Projects/GraduationProject/Fused_sum_SSD_VHR_300/weights/v2_vhr.pth')
    ...
    for i in range(detections.size(1)):
        ...
        while detections[0, i, j, 0] >= 0.6:
            ...
            j += 1
    plt.savefig(
        '/media/sunwl/Datum/Projects/GraduationProject/Fused_sum_SSD_VHR_300/outputs/rosd_{:03}.png'.format(img_id))
    plt.xticks([])
    plt.yticks([])
    plt.show()
...
def demo_cv2(img_id=0):
    net = build_ssd('test', 300, 5)  # initialize SSD
    print(net)
    net.load_weights('/media/sunwl/Datum/Projects/GraduationProject/Fused_sum_SSD_VHR_300/weights/v2_vhr.pth')
    testset = ROSDDetection(ROSDroot, ['test'], None, AnnotationTransform_ROSD)
    # image = testset.pull_image(img_id)
    ...
    cv2.imwrite(os.path.join('/media/sunwl/Datum/Projects/GraduationProject/Fused_sum_SSD_VHR_300', "outputs",
